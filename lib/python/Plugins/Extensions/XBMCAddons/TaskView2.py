...
THISPLUG = "/usr/lib/enigma2/python/Plugins/Extensions/XBMCPlugin"
...
class JobViewNew(InfoBarNotifications, Screen, ConfigListScreen):
    ...
    <widget name="pixmap" position="942,372" size="200,200" zPosition="1" alphatest="on" />
		...
		<widget source="job_name" render="Label" position="100,100" size="480,60" font="Regular;28" backgroundColor="#40000000" />
