...
from Components.config import ConfigSubsection, ConfigInteger, ConfigText, getConfigListEntry, ConfigSelection, ConfigIP, ConfigYesNo, ConfigSequence, ConfigNumber, NoSave, ConfigEnableDisable, configfile, ConfigBoolean
...
config.plugins.extraspanel_frozencheck.list = ConfigSelection([('0', _('Off')),
 ('1', _('1 min.')),
 ('5', _('5 min.')),
 ('10', _('10 min.')),
 ('15', _('15 min.')),
...
class ShowSoftcamPanelExtensions(ConfigListScreen, Screen):
	...
	def createSetup(self):
		self.editListEntry = None
		self.list = []
#        self.list.append(getConfigListEntry(_('Show Softcam-Panel in Extensions Menu'), config.plugins.showextraspanelextensions))
